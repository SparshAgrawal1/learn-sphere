/**
 * Main JavaScript for The Last Leaf interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Last Leaf'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Last Leaf'. This is a touching story about hope, sacrifice, and the will to live.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about what hope means and how it can affect our physical and mental well-being.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore key vocabulary and sentence structures from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Last Leaf'. Let's begin by exploring how hope and will to live can affect our health. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Last Leaf'. Let's begin by exploring how hope and will to live can affect our health.");
        }
    }
}
