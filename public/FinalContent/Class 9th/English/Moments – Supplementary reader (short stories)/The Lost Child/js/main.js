/**
 * Main JavaScript for The Lost Child interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Lost Child'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Lost Child'. This is a touching story about a young child who gets separated from his parents at a fair.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about what it would feel like to be lost in a crowded place like a fair.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Language section. Here you'll explore important vocabulary and descriptive language from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Lost Child'. Let's begin by exploring what you might feel if you were lost at a fair. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Lost Child'. Let's begin by exploring what it might feel like to be lost at a fair.");
        }
    }
}
