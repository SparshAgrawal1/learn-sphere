/**
 * Main JavaScript for CV Raman interactive Hindi lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "वैज्ञानिक चेतना के वाहक चंद्रशेखर वेंकट रामन् में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("वैज्ञानिक चेतना के वाहक चंद्रशेखर वेंकट रामन् में आपका स्वागत है। यह पाठ भारत के प्रथम नोबेल पुरस्कार विजेता वैज्ञानिक की जीवन गाथा पर आधारित है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    let prereadingContent = "पाठ प्रवेश में आपका स्वागत है। ";
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("प्रश्न-अभ्यास खंड में आपका स्वागत है। यहां आप पाठ पर आधारित प्रश्नों के उत्तर देंगे।");
            }
            break;
            
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("भाषा अध्ययन खंड में आपका स्वागत है। यहां आप शब्दार्थ और वाक्य प्रयोग का अभ्यास करेंगे।");
            }
            break;
            
        case 'activities':
            if (window.narrator) {
                window.narrator.speak("योग्यता विस्तार खंड में आपका स्वागत है। यहां आप अनुसंधान गतिविधि और परियोजना कार्य करेंगे।");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'activities': return 'योग्यता विस्तार';
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "चंद्रशेखर वेंकट रामन् के जीवन की यात्रा शुरू करते हैं। आइए पाठ प्रवेश से शुरू करते हैं। ";
            ...
            narrator.speak("चंद्रशेखर वेंकट रामन् के जीवन की यात्रा शुरू करते हैं।");
        }
    }
}
...
function saveResearchNotes() {
    const selectedOption = document.querySelector('input[name="research"]:checked');
    ...
    feedbackEl.textContent = 'आपका अनुसंधान विषय चुना गया है! अब आप इस विषय पर जानकारी एकत्रित कर सकते हैं।';
    feedbackEl.className = 'feedback-message show success';
    ...
    if (!modulesCompleted.includes('activities')) {
        ...
        updateProgress();
        showAchievement('अनुसंधान विषय चयन पूर्ण!');
    }
...
// Save project choice
function saveProjectChoice() {
    const selectedOption = document.querySelector('input[name="project"]:checked');
    const feedbackEl = document.getElementById('projectFeedback');
    
    if (!selectedOption) {
        feedbackEl.textContent = 'कृपया कोई एक परियोजना चुनें।';
        feedbackEl.className = 'feedback-message show error';
        return;
    }
    
    feedbackEl.textContent = 'आपकी परियोजना चुनी गई है! अब आप इस परियोजना पर काम शुरू कर सकते हैं।';
    feedbackEl.className = 'feedback-message show success';
    ...
    if (!modulesCompleted.includes('activities')) {
        modulesCompleted.push('activities');
        updateProgress();
        showAchievement('परियोजना चयन पूर्ण!');
    }
