/**
 * Main JavaScript for In the Kingdom of Fools interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'In the Kingdom of Fools'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'In the Kingdom of Fools'. This is a Kannada folktale about a kingdom ruled by a foolish king and his equally foolish minister.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about foolishness and wisdom. Sometimes, what seems foolish might have its own wisdom, and what appears wise might actually be foolish.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore word functions and conditional sentences from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'In the Kingdom of Fools'. Let's begin by exploring what you think about foolishness and wisdom. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'In the Kingdom of Fools'. Let's begin by exploring what you think about foolishness and wisdom.");
        }
    }
}
