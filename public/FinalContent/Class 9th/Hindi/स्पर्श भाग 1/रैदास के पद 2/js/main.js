/**
 * Main JavaScript for Raidas Ke Pad interactive Hindi lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "कबीर की साखी में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("कबीर की साखी में आपका स्वागत है। यह पाठ संत कवि कबीर के जीवन और उनकी सिखाओं का अन्वेषण करता है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("पाठ प्रवेश खंड में आपका स्वागत है। यहां हम 'साखी' शब्द के अर्थ और कबीर के अनुभव ज्ञान के महत्व पर चर्चा करेंगे।");
                }
            }
            break;
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("प्रश्न-अभ्यास खंड में आपका स्वागत है। यहां आप साखी का विश्लेषण करके प्रश्नों के उत्तर देंगे।");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "कबीर की साखी में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और साखी शब्द के अर्थ और महत्व के बारे में जानते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("कबीर की साखी में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और साखी शब्द के अर्थ और महत्व के बारे में जानते हैं।");
        }
    }
}
