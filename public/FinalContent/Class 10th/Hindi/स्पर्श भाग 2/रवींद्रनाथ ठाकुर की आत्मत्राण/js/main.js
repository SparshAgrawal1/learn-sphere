        ...
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "रवींद्रनाथ ठाकुर की आत्मत्राण में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("रवींद्रनाथ ठाकुर की आत्मत्राण में आपका स्वागत है। यह पाठ प्रसिद्ध कवि रवींद्रनाथ ठाकुर के जीवन और उनकी कविता का अध्ययन करता है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("पाठ प्रवेश खंड में आपका स्वागत है। यहां हम 'आत्मत्राण' कविता के महत्व और संदर्भ पर चर्चा करेंगे।");
                }
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "रवींद्रनाथ ठाकुर की आत्मत्राण में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("रवींद्रनाथ ठाकुर की आत्मत्राण में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं।");
        }
    }
}
