/**
 * Main JavaScript for Iswaran the Storyteller interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'Iswaran the Storyteller'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Iswaran the Storyteller'. This is a story about a cook who was an excellent storyteller.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about storytelling and how different people tell stories in different ways.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary and adverbs from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Iswaran the Storyteller'. Let's begin by exploring the power of storytelling. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Iswaran the Storyteller'. Let's begin by exploring the power of storytelling.");
        }
    }
}
