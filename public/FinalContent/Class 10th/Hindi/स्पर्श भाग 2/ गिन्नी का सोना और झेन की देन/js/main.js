/**
 * Main JavaScript for Ginni ka Sona interactive Hindi lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "गिन्नी का सोना और झेन की देन में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("गिन्नी का सोना और झेन की देन में आपका स्वागत है। यह पाठ रवींद्र केलेकर की रचना पर आधारित है।");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("भाषा अध्ययन खंड में आपका स्वागत है। यहां आप शब्दों के पर्याय, द्वंद्व समास और भाववाचक संज्ञा का अध्ययन करेंगे।");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "गिन्नी का सोना और झेन की देन में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और पाठ के विषय और पृष्ठभूमि के बारे में जानते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("गिन्नी का सोना और झेन की देन में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और पाठ के विषय और पृष्ठभूमि के बारे में जानते हैं।");
        }
    }
}
...
function toggleReadAloud() {
    // This function will be defined in ginni-ka-sona-story.js
    if (typeof readCurrentStoryPartAloud === 'function') {
        readCurrentStoryPartAloud();
    } else {
...
// Check idiom usage (d्वंद्व समास)
function checkIdioms() {
    const idiomAnswers = {
        idiom1: "1", // माता और पिता
        idiom2: "3", // पाप और पुण्य
        idiom3: "1", // सुख और दुख
        idiom4: "2"  // घर और बाहर
    };
    ...
    if (feedbackEl) {
        if (correctCount === totalCount) {
            feedbackEl.textContent = 'सभी उत्तर सही हैं! द्वंद्व समास की समझ उत्कृष्ट है।';
            feedbackEl.className = 'feedback-message show success';
...
function checkGrammar() {
    ...
    if (feedbackEl) {
        if (correctCount === totalCount) {
            feedbackEl.textContent = 'सभी उत्तर सही हैं! आप भाववाचक संज्ञा की पहचान अच्छी तरह से कर सकते हैं।';
            feedbackEl.className = 'feedback-message show success';
