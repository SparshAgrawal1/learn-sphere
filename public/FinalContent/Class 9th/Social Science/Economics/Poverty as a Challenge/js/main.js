...
const moduleOrder = ['intro', 'overview', 'southafrica', 'whyconstitution', 'indianconstitution', 'summingup', 'activities'];
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            speak("This lesson explores poverty as a challenge in India. Using the Multidimensional Poverty Index by NITI Aayog, we examine how poverty affects millions of people, from landless laborers in villages to those living in urban slums. The index shows significant progress in poverty reduction over the years.");
            break;
            
        case 'overview':
            speak("This chapter examines poverty as one of independent India's major challenges. It explores the multidimensional nature of poverty through real examples and discusses how social scientists analyze this issue. The chapter covers poverty trends in India and globally using the poverty line concept, examines the causes of poverty, reviews government anti-poverty measures, and concludes by broadening the concept from official poverty to human poverty.");
            break;
            
        case 'southafrica':
            speak("This section presents seven case studies on poverty in India. First, we examine an urban poverty case through Ram Saran's story in Ranchi, followed by a rural poverty case with Lakha Singh in Meerut. We then explore how social scientists view poverty through various indicators, understand social exclusion and vulnerability as dimensions of poverty, learn about the poverty line concept and estimation methods, and examine poverty estimates across different time periods.");
            break;
            
        case 'whyconstitution':
            speak("This section continues the poverty analysis with seven additional case studies. We examine inter-state disparities in poverty across Indian states, identify vulnerable groups most affected by poverty, explore the global poverty scenario and international comparisons, understand poverty in relation to Sustainable Development Goals, analyze the historical and current causes of poverty in India, review anti-poverty measures and government initiatives, and discuss the challenges ahead for poverty reduction.");
            break;
            
        case 'indianconstitution':
            speak("NITI Aayog has developed the National Multidimensional Poverty Index using twelve key indicators to measure poverty in India. These indicators cover three main dimensions: health, education, and standard of living. The index identifies households as multidimensionally poor if they are deprived in at least one-third of these weighted indicators, providing a comprehensive view of poverty beyond just income-based measurements.");
            break;
            

        case 'summingup':
            speak("This chapter examined different approaches to measuring poverty. The National Multidimensional Poverty Index by NITI Aayog shows significant reduction in multidimensional poverty across India, with some states achieving very low poverty rates while others continue to make progress through government interventions.");
            break;

        case 'activities':
            speak("Test your knowledge and understanding with these interactive activities about Poverty as a Challenge.");
            break;
...
function startJourney() {
    ...
    speak("Welcome to the interactive lesson on Poverty as a Challenge. Let's begin by understanding poverty in India through the Multidimensional Poverty Index and explore the various dimensions and solutions to this critical issue.");
}
...
// Twelve Indicators of National Multidimensional Poverty Index Narration
function toggleNMPIIndicatorsNarration() {
    const btn = document.getElementById('nmpiIndicatorsSpeakerBtn');
    if (!btn) return;
    ...
    // Use the full NMPI content for narration
    const curatedContent = "NITI Aayog, a Government of India organisation evolved the National Multidimensional Poverty Index (NMPI) using the following 12 indicators. If an individual is found deprived on these indicators, he or she is considered as multidimensional poor. 1. Nutrition: A household is considered deprived if any child between the ages of 0 to 59 months, or woman between the ages of 15 to 49 years, or man between the ages of 15 to 54 years is found to be undernourished. 2. Child-Adolescent Mortality: A household is deprived if any child or adolescent under 18 years of age has died in the household in the five-year period preceding the survey. 3. Maternal Health: A household is deprived if any woman in the household who has given birth in the 5 years preceding the survey has not received assistance from trained skilled medical personnel during the recent childbirth. 4. Years of Schooling: A household is deprived if not even one member of the household aged 10 years or older has completed six years of schooling. 5. School attendance: A household is deprived if any school-aged child is not attending school up to the age at which he/she would complete class. 6. Cooking Fuel: A household is deprived if a household cooks with dung, agricultural crops, shrubs, wood, charcoal, or coal. 7. Sanitation: A household is deprived if the household has unimproved or no sanitation facility or it is improved but shared with other households. 8. Drinking Water: A household is deprived if the household does not have access to improved drinking water or safe drinking water is at least a 30-minute walk from home (as a round trip). 9. Housing: A household is deprived if the household has inadequate housing: the floor is made of natural materials, or the roof or wall are made of rudimentary materials. 10. Electricity: A household is deprived if the household has no electricity. 11. Assets: A household is deprived if the household does not own more than one of these assets: radio, TV, telephone, computer, animal cart, bicycle, motorbike, or refrigerator; and does not own a car or truck. 12. Bank Account: A household is deprived if no household member has a bank account or a post office account.";
    ...
    try {
        ...
        console.error('Error speaking NMPI content:', err);
        onCleanup();
    }
}
