/**
 * Main JavaScript for The Adventures of Toto interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Adventures of Toto'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Adventures of Toto'. This is a story about a mischievous little monkey and his adventures with the narrator's grandfather.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about what we know about monkeys and their behavior.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary related to animal behavior and characteristics.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Adventures of Toto'. Let's begin by exploring what you think about monkeys and pets. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Adventures of Toto'. Let's begin by exploring what you think about monkeys and pets.");
        }
    }
}
