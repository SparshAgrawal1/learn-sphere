/**
 * Main JavaScript for Kartoos interactive Hindi lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "कारतूस में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("कारतूस में आपका स्वागत है। यह पाठ हबीब तनवीर के नाटक पर आधारित है, जो वज़ीर अली नामक एक जाँबाज़ व्यक्ति के साहस और देशभक्ति की कहानी है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("पाठ प्रवेश खंड में आपका स्वागत है। अंग्रेज़ इस देश में व्यापारी के भेष में आए थे, लेकिन धीरे-धीरे उन्होंने रियासतों पर कब्ज़ा जमा लिया। इसी संदर्भ में वज़ीर अली की कहानी है।");
                }
            }
            break;
            
        case 'story':
            // Automatically start reading the play
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("प्रश्न-अभ्यास खंड में आपका स्वागत है। यहां आप नाटक का विश्लेषण करके प्रश्नों के उत्तर देंगे।");
            }
            break;
            
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("भाषा अध्ययन खंड में आपका स्वागत है। यहां आप शब्दों के पर्याय और मुहावरों का अध्ययन करेंगे।");
            }
            break;
            
        case 'activities':
            if (window.narrator) {
                window.narrator.speak("गतिविधि खंड में आपका स्वागत है। यहां आप विभिन्न क्रियाकलापों में भाग लेंगे, जिनमें अनुसंधान और रोल-प्ले शामिल हैं।");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "कारतूस में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और नाटक के विषय और पृष्ठभूमि के बारे में जानते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("कारतूस में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और नाटक के विषय और पृष्ठभूमि के बारे में जानते हैं।");
        }
    }
}
...
function toggleReadAloud() {
    // This function will be defined in kartoos-story.js
    if (typeof readCurrentStoryPartAloud === 'function') {
        readCurrentStoryPartAloud();
    } else {
...
function saveReflection() {
    ...
    // Display feedback
    feedbackEl.textContent = 'आपका चिंतन सहेज लिया गया है! वज़ीर अली की दिलेरी और देशभक्ति पर आपके विचार सराहनीय हैं।';
...
function checkIdioms() {
    const idiomFields = [
        document.getElementById('idiom1'),
        document.getElementById('idiom2'),
        document.getElementById('idiom3'),
        document.getElementById('idiom4')
    ];
    
    let completedCount = 0;
    
    idiomFields.forEach(field => {
    ...
    if (feedbackEl) {
        if (completedCount === idiomFields.length) {
            feedbackEl.textContent = 'सभी मुहावरों का प्रयोग पूर्ण! आपके द्वारा बनाए गए वाक्य उत्कृष्ट हैं।';
            feedbackEl.className = 'feedback-message show success';
            ...
            if (!modulesCompleted.includes('thinking-language')) {
                modulesCompleted.push('thinking-language');
                updateProgress();
                showAchievement('मुहावरा अभ्यास पूर्ण!');
            }
        } else {
            feedbackEl.textContent = `कृपया सभी ${idiomFields.length} मुहावरों के लिए वाक्य लिखें।`;
            feedbackEl.className = 'feedback-message show error';
        }
    }
...
function checkGrammar() {
    ...
    if (feedbackEl) {
        if (correctCount === totalCount) {
            feedbackEl.textContent = 'सभी उत्तर सही हैं! आप विशेषण और विशेष्य की पहचान अच्छी तरह से कर सकते हैं।';
            feedbackEl.className = 'feedback-message show success';
...
function saveResearchNotes() {
    ...
    if (researchNotes && researchNotes.value.trim().length > 0) {
        feedbackEl.textContent = 'आपके शोध निष्कर्ष सहेज लिए गए हैं! हबीब तनवीर के योगदान पर आपका अनुसंधान उत्कृष्ट है।';
        feedbackEl.className = 'feedback-message show success';
        ...
        if (!modulesCompleted.includes('activities')) {
            ...
            updateProgress();
            showAchievement('अनुसंधान गतिविधि पूर्ण!');
        }
    } else {
        feedbackEl.textContent = 'कृपया अपने शोध निष्कर्ष दर्ज करें।';
        feedbackEl.className = 'feedback-message show error';
    }
...
function saveRolePlay() {
    ...
    if (rolePlayText && rolePlayText.value.trim().length > 50) {
        feedbackEl.textContent = 'आपके द्वारा रचित संवाद सहेज लिया गया है! आपने वज़ीर अली और कर्नल के चरित्रों को अच्छी तरह से दर्शाया है।';
        feedbackEl.className = 'feedback-message show success';
        ...
        if (!modulesCompleted.includes('activities')) {
            modulesCompleted.push('activities');
            updateProgress();
            showAchievement('रोल-प्ले गतिविधि पूर्ण!');
        }
    } else {
        feedbackEl.textContent = 'कृपया कम से कम 50 अक्षरों का संवाद लिखें।';
        feedbackEl.className = 'feedback-message show error';
    }
