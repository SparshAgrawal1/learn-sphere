/**
 * Main JavaScript for Geet-Ageet interactive Hindi lesson
 */
        ...
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "गीत-अगीत में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("गीत-अगीत में आपका स्वागत है। यह पाठ रामधारी सिंह दिनकर की कविता का अन्वेषण करता है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("पाठ प्रवेश खंड में आपका स्वागत है। यहां हम 'गीत-अगीत' कविता के अर्थ और महत्व पर चर्चा करेंगे।");
                }
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "गीत-अगीत में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और कविता के अर्थ और महत्व के बारे में जानते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("गीत-अगीत में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और कविता के अर्थ और महत्व के बारे में जानते हैं।");
        }
    }
}
...
// Dinkar's life content for listening activity
const dinkarLifeContent = `
...
दिनकर जी को 'संस्कृति के चार अध्याय' पुस्तक पर साहित्य अकादमी पुरस्कार मिला। अपनी काव्यकृति 'उर्वशी' के लिए इन्हें ज्ञानपीठ पुरस्कार से सम्मानित किया गया। दिनकर की प्रमुख कृतियाँ हैं: हुँकार, कुरुक्षेत्र, रश्मिरथी, परशुराम की प्रतीक्षा, उर्वशी और संस्कृति के चार अध्याय।
...
इनकी कुछ कृतियों में प्रेम और सौंदर्य का भी चित्रण है। दिनकर ने अपनी कविताओं में प्रकृति के सौंदर्य, मानवीय भावनाओं और सामाजिक चेतना को बखूबी व्यक्त किया है। उनकी कविता 'गीत-अगीत' में प्रकृति के सौंदर्य के अतिरिक्त जीव-जंतुओं के ममत्व, मानवीय राग और प्रेमभाव का भी सजीव चित्रण है।

दिनकर का आविर्भाव ऐसे समय में हुआ जब भारत स्वतंत्रता संग्राम के दौर से गुजर रहा था। वे क्रांतदर्शी कवि थे जिनकी कविता में गहरी सामाजिक चेतना झलकती है। आज भी उनके विचार और शिक्षाएँ प्रासंगिक हैं।
`;
...
function playListeningActivity() {
    if (window.narrator) {
        ...
        const contentParagraphs = dinkarLifeContent.split('\n\n').filter(p => p.trim().length > 0);
        ...
        // Start speaking the paragraphs
        speakSequentially(contentParagraphs);
    } else {
        alert('वास्तविक कार्यान्वयन में, यह दिनकर के जीवन के बारे में ऑडियो चलाएगा।');
    }
}

// Open writing pad
function openWritingPad() {
    // In a real app, this would open a writing interface
    alert('वास्तविक कार्यान्वयन में, यह एक लेखन पैड खोलेगा जहाँ आप अपने विचार लिख सकते हैं।');
    
    if (narrator) {
        narrator.speak("लेखन पैड खोला गया। आप यहाँ अपने विचार लिख सकते हैं।");
    }
}
...
function showResource(resourceId) {
    ...
    if (narrator) {
        switch(resourceId) {
            case 'dinkar-life':
                narrator.speak("रामधारी सिंह दिनकर का जन्म 1908 में बिहार के मुंगेर जिले के सिमरिया गाँव में हुआ था। वे सन् 1952 में राज्यसभा के सदस्य मनोनीत किए गए। भारत सरकार ने इन्हें 'पद्मभूषण' अलंकरण से भी अलंकृत किया।");
                break;
            case 'dinkar-photos':
                narrator.speak("ये चित्र दिनकर के जीवन और उनके कार्यों को दर्शाते हैं।");
                break;
            case 'project-template':
                narrator.speak("यह टेम्पलेट दिनकर के जीवन और उनकी कविता 'गीत-अगीत' पर आपके प्रोजेक्ट के लिए एक संरचना प्रदान करता है।");
                break;
        }
    }
}
