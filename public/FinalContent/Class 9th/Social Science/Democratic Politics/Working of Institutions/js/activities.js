...
function resetQuiz() {
    ...
    if (progressFill) {
        progressFill.style.width = '16.67%';
        progressFill.textContent = 'Question 1 of 6';
    }
...
// Helper function to get ministry name from ID
function getMinistryName(id) {
    ...
    return ministries[id] || 'Unknown Ministry';
}
...
function initializeQuestionStates() {
    // Define all question IDs for Additional Questions
    const questionIds = [
        'q1a', 'q1b', 'q1c', 'q1d', 'q3', 'q4'
    ];
...
function checkQuizAnswers() {
    ...
    // Question 5: a) In a Parliamentary democracy only the leader of the majority party in the Lok Sabha can become the Prime Minister
    const q5Answer = document.querySelector('input[name="q5"]:checked');
    if (q5Answer && q5Answer.value === 'a') {
        score++;
        results.push('<p class="correct-answer">✓ Question 5: Correct! In a Parliamentary democracy only the leader of the majority party in the Lok Sabha can become the Prime Minister.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 5: Incorrect. The correct answer is a) In a Parliamentary democracy only the leader of the majority party in the Lok Sabha can become the Prime Minister.</p>');
    }

    // Question 6: b) Anjaiah says that judiciary is independent because it could have given a verdict against the government order
    const q6Answer = document.querySelector('input[name="q6"]:checked');
    if (q6Answer && q6Answer.value === 'b') {
        score++;
        results.push('<p class="correct-answer">✓ Question 6: Correct! The judiciary is independent because it could have given a verdict against the government order but chose to direct the government to modify it.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 6: Incorrect. The correct answer is b) Anjaiah says that judiciary is independent because it could have given a verdict against the government order. The Supreme Court did direct the government to modify it.</p>');
    }
