...
function checkMatchingAnswers() {
    ...
    // Define correct answers for power sharing matching
    const correctAnswers = {
        '1': 'b',  // Power shared among different organs of government → Separation of powers
        '2': 'd',  // Power shared among governments at different levels → Federal government
        '3': 'a',  // Power shared by different social groups → Community government
        '4': 'c'   // Power shared by two or more political parties → Coalition government
    };
