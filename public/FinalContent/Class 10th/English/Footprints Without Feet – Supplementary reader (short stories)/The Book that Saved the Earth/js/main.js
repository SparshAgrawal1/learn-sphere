/**
 * Main JavaScript for The Book That Saved the Earth interactive lesson
 */
...
function showModule(moduleId) {
    ...
    switch(moduleId) {
        case 'play':
            // Load the play content if needed
            if (typeof playContent !== 'undefined') {
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Book That Saved the Earth'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Book That Saved the Earth'. This is a humorous play about a Martian invasion that is stopped by a book of nursery rhymes.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about books and literature and how they can influence people's thinking.");
                }
            }
            break;
        ...
        case 'play':
            ...
            if (typeof readPlayAloud === 'function') {
                readPlayAloud();
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary and answer questions about the play.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Book That Saved the Earth'. Let's begin by exploring what you think about books and literature. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Book That Saved the Earth'. Let's begin by exploring what you think about books and literature.");
        }
    }
}
