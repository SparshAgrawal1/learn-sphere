/**
 * Main JavaScript for A House Is Not a Home interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'A House Is Not a Home'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'A House Is Not a Home'. This is a story about loss, adaptation and finding community.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about what makes a house a home, and reflect on loss and adaptation.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore key words and language features from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'A House Is Not a Home'. Let's begin by exploring what you think about the difference between a house and a home. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'A House Is Not a Home'. Let's begin by exploring what makes a house a home.");
        }
    }
}
