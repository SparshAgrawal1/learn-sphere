/**
 * Main JavaScript for The Happy Prince interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Happy Prince'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Happy Prince'. This is a heartwarming tale of selflessness, sacrifice, and true happiness by Oscar Wilde.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Let's begin exploring 'The Happy Prince'. In this story, we'll learn about compassion, sacrifice, and what true happiness really means.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Literary Devices section. Here you'll explore the rich language used in 'The Happy Prince'.");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'thinking-language': return 'Vocabulary & Literary Devices';
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Happy Prince'. Let's begin by exploring what true happiness means. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Happy Prince'. Let's begin by exploring what true happiness means.");
        }
    }
}
