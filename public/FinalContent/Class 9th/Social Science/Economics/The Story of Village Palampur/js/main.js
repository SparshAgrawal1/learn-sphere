...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            speak("Welcome to The Story of Village Palampur. This lesson introduces basic concepts of production through the story of a hypothetical village where farming is the main activity, supported by small-scale manufacturing, dairy, and transport. We will learn how various resources combine to produce goods and services.");
            break;
            
        case 'overview':
            speak("Palampur is well-connected with neighbouring villages and towns. The village has about 450 families with well-developed infrastructure including roads, transport, electricity, schools and health centers. The story will take us through different production activities in the village, focusing on farming as the main activity and various non-farm activities.");
            break;
            
        case 'southafrica':
            speak("Production requires four factors: land and natural resources, labour, physical capital, and human capital. Physical capital includes tools, machines, and raw materials needed for production.");
            break;
            
        case 'whyconstitution':
            speak("Farming is the main production activity in Palampur, covering crucial aspects like land constraints, multiple cropping, modern farming methods, land distribution, labour requirements, capital needs, and surplus marketing.");
            break;
            
        case 'indianconstitution':
            speak("We have learnt about farming as the main production activity in Palampur. We shall now take a look at some of the non-farm production activities. Only 25 per cent of the people working in Palampur are engaged in activities other than agriculture. This section covers dairy farming, small-scale manufacturing, shopkeeping, and the transport sector as important non-farm activities in the village.");
            break;
            

        case 'summingup':
            speak("Farming is the main production activity in Palampur village. Small farmers struggle with capital while labor migrates to cities, with only 24% in non-farm activities.");
            break;

        case 'activities':
            speak("Test your knowledge and understanding with these interactive activities about The Story of Village Palampur.");
            break;
...
function startJourney() {
    ...
    showAchievement('Journey Begins', 'You started your learning journey with The Story of Village Palampur!');
    speak("Welcome to the interactive lesson on The Story of Village Palampur. Let's begin by understanding the basic concepts of production and how resources combine to produce goods and services in the village.");
}
