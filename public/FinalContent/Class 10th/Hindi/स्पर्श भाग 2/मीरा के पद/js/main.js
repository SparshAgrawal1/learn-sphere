/**
 * Main JavaScript for Meera Ke Pad interactive Hindi lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "मीरा के पद में आपका स्वागत है। ";
                    ...
                    window.narrator.speak("मीरा के पद में आपका स्वागत है। यह पाठ मध्यकालीन भक्ति कवयित्री मीराबाई के जीवन और उनकी सिखाओं का अन्वेषण करता है।");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("पाठ प्रवेश खंड में आपका स्वागत है। यहां हम मीरा के पदों और उनकी भक्ति भावना पर चर्चा करेंगे।");
                }
            }
            break;
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("प्रश्न-अभ्यास खंड में आपका स्वागत है। यहां आप मीरा के पदों का विश्लेषण करके प्रश्नों के उत्तर देंगे।");
            }
            break;
...
// Update Progress
function updateProgress(moduleId, pointsToAdd) {
    // If moduleId and pointsToAdd are provided, add points to score
    if (moduleId && pointsToAdd) {
        score += pointsToAdd;
        document.getElementById('totalScore').textContent = score;
    }
    
    // Update progress bar based on completed modules
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "मीरा के पद में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और मीरा के पदों के बारे में जानते हैं। ";
            ...
            // Fallback if module not found
            narrator.speak("मीरा के पद में आपका स्वागत है। आइए पाठ प्रवेश से शुरू करते हैं और मीरा के पदों के बारे में जानते हैं।");
        }
    }
}
...
function toggleReadAloud() {
    // This function is called from the story module to toggle narration
    if (typeof readStoryPartAloud === 'function') {
        // Find which story part is currently active
