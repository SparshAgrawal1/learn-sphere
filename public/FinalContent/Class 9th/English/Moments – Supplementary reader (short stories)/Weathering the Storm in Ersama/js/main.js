/**
 * Main JavaScript for Weathering the Storm in Ersama interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'Weathering the Storm in Ersama'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Weathering the Storm in Ersama'. This is a powerful story about community resilience in the face of a natural disaster.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about natural disasters and how communities come together to help each other during such times.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary related to natural disasters and community resilience.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Weathering the Storm in Ersama'. Let's begin by exploring what you think about natural disasters and community response. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Weathering the Storm in Ersama'. Let's begin by exploring what you think about natural disasters and community response.");
        }
    }
}
