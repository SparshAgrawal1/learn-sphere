/**
 * Main JavaScript for The Midnight Visitor interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Midnight Visitor'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Midnight Visitor'. This is a story about a secret agent who uses his wits rather than weapons to overcome a dangerous situation.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about secret agents and spies from books and movies.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Presence of Mind section. Here you'll explore vocabulary from the story and think about quick decision-making in different situations.");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'thinking-language': return 'Vocabulary & Presence of Mind';
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Midnight Visitor'. Let's begin by exploring what you know about secret agents and spies. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Midnight Visitor'. Let's begin by exploring what you know about secret agents and spies.");
        }
    }
}
