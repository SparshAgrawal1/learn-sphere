...
const moduleOrder = ['intro', 'overview', 'southafrica', 'whyconstitution', 'indianconstitution', 'values', 'decentralisation', 'activities'];
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
             speak("Welcome to Federalism. This chapter explores federalism as a key form of power-sharing in modern democracies, focusing on how authority is divided among different levels of government, with special emphasis on India's federal system and the role of local governments.");
             break;
            
        case 'overview':
             speak("This chapter focuses on federalism as a form of power-sharing, examining its theory and practice in India, including federal constitutional provisions, policies that have strengthened federalism, and the emergence of local government as the third tier of Indian federalism.");
             break;
            
        case 'southafrica':
             speak("This section explains federalism as a system of government where power is divided between central and state governments, contrasting it with unitary systems and examining key features of federalism including its dual objectives of promoting unity while accommodating regional diversity.");
             break;
            
        case 'whyconstitution':
             speak("This section outlines the key features of federalism, including multiple levels of government, constitutional jurisdiction, financial autonomy, and dual objectives of promoting national unity while accommodating regional diversity, along with different routes through which federations are formed.");
             break;
            
        case 'indianconstitution':
             speak("This section explains what makes India a federal country, examining the constitutional provisions including the three lists of subjects, special status for certain states, union territories, and the rigid procedures for amending the power-sharing arrangement between center and states.");
             break;
            
        case 'values':
            speak("This section explores how federalism is practised in India through democratic politics. It examines the role of linguistic states, language policy, centre-state relations, and linguistic diversity in strengthening federalism beyond just constitutional provisions.");
            break;

        case 'decentralisation':
            speak("This section discusses decentralisation in India, explaining the need for a third tier of government at the local level, the constitutional amendments of 1992 that strengthened local governments, and the structure and functioning of rural and urban local bodies including panchayats and municipalities.");
            break;
...
function checkQuizAnswers() {
    ...
    // Question 1: (d) Governmental power is divided between different levels of government.
    const q1Answer = document.querySelector('input[name="q1"]:checked');
    if (q1Answer && q1Answer.value === 'd') {
        score++;
        results.push('<p class="correct-answer">✓ Question 1: Correct! Governmental power is divided between different levels of government.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 1: Incorrect. The correct answer is (d) Governmental power is divided between different levels of government.</p>');
    }

    // Question 2: (c) A and B only
    const q2Answer = document.querySelector('input[name="q2"]:checked');
    if (q2Answer && q2Answer.value === 'c') {
        score++;
        results.push('<p class="correct-answer">✓ Question 2: Correct! A and B only are correct statements.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 2: Incorrect. The correct answer is (c) A and B only.</p>');
    }
...
function toggleDecentralisationNarration() {
    ...
    // Read paragraphs sequentially for better narration flow
    readParagraphsSequentiallyForDecentralisation(paragraphs, btn);
}
...
// Helper function to read paragraphs sequentially for Decentralisation section
function readParagraphsSequentiallyForDecentralisation(paragraphs, button) {
    // Initialize paragraph timeouts array
...
function toggleIntroNarration() {
    ...
    const curatedContent = contentElement ? contentElement.textContent.trim() : "This chapter explores federalism, a key form of power-sharing in modern democracies where authority is divided among different levels of government. It explains the concept of federalism, its working in India, and how constitutional provisions and political practices have strengthened it over time. The chapter also discusses the emergence of local governments as the third tier, highlighting how decentralisation brings governance closer to the people and makes democracy more effective.";
...
function toggleFederalismPractiseNarration() {
    console.log('Federalism practise narration function called');

    const btn = document.getElementById('federalismPractiseSpeakerBtn');
    if (!btn) {
        console.error('Federalism practise speaker button not found!');
        showFeedback('Error: Narration button not found. Please refresh the page.', 'error');
        return;
    }
    ...
    try {
        console.log('Attempting to speak Federalism practise content...');
        window.speechSynthesis.speak(utter);
        console.log('Speech synthesis request sent successfully');
    } catch (err) {
        console.error('Error speaking content:', err);
