    ...
    if ('speechSynthesis' in window) {
        ...
        narrator = {
            ...
            selectStandardVoice: function(voices) {
                // Try to find a high-quality British male voice
                let preferredVoice = voices.find(voice => 
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Mijbil the Otter'. This is a heartwarming tale about the bond between humans and animals.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about pet ownership and the responsibilities that come with caring for an animal.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore the usage of 'would' and 'used to' for describing repeated actions in the past, as well as noun modifiers.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Mijbil the Otter'. Let's begin by exploring what it means to care for a pet. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Mijbil the Otter'. Let's begin by exploring what it means to care for a pet.");
        }
    }
}
