/**
 * Main JavaScript for A Question of Trust interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'A Question of Trust'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'A Question of Trust'. This is a story about honesty, deception, and the consequences of our actions.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about the concept of trust and honesty in our society.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore words and language patterns from the story.");
            }
            break;
...
function updateProgress() {
    progress = (modulesCompleted.length / 5) * 100; // Only 5 modules for this lesson
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'A Question of Trust'. Let's begin by exploring what you think about trust and honesty. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'A Question of Trust'. Let's begin by exploring what you think about trust and honesty.");
        }
    }
}
