/**
 * Main JavaScript for Footprints without Feet interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'Footprints without Feet'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'Footprints without Feet'. This is a story by H.G. Wells about a scientist who discovers how to make himself invisible.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about scientific ethics and the responsibilities of scientists.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore key words and language points from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'Footprints without Feet'. Let's begin by exploring the ethics of scientific discovery. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'Footprints without Feet'. Let's begin by exploring the ethics of scientific discovery.");
        }
    }
}
