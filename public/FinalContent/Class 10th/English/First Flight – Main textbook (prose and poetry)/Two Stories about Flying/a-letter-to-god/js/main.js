/**
 * Main JavaScript for A Letter to God interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'A Letter to God'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'A Letter to God'. This is a story about faith and belief.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about faith, belief, and how they shape our actions.");
                }
            }
            break;
        ...
        case 'poem1':
            // Automatically start reading the Dust of Snow poem
        ...
        case 'poem2':
            // Automatically start reading the Fire and Ice poem
            if (typeof readPoemAloud === 'function') {
                readPoemAloud('poem2');
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore vocabulary and grammar from the story.");
            }
            break;
...
function getModuleName(moduleId) {
    switch (moduleId) {
        ...
        case 'poem1': return 'Dust of Snow';
        case 'poem2': return 'Fire and Ice';
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'A Letter to God'. Let's begin by exploring what you think about faith and belief. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'A Letter to God'. Let's begin by exploring what you think about faith and belief.");
        }
    }
}
