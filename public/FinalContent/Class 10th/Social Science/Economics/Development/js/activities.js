...
function checkAnswer(optionIndex) {
    ...
    const correctAnswers = [3, 1, 3]; // d, b, d (0-indexed)
...
function nextQuestion() {
    const totalQuestions = 3; // We have 3 questions in the HTML
...
function initializeCriticalThinkingQuestions() {
    // Ensure all text areas are enabled by default for questions 1-9
    for (let i = 1; i <= 9; i++) {
    ...
    // Handle question 10 with two parts
    const textarea10i = document.getElementById('answer-10i');
    const submitBtn10i = document.querySelector('#question-10 .submit-btn:nth-of-type(1)');
    const editBtn10i = document.querySelector('#question-10 .edit-btn:nth-of-type(1)');
    const textarea10ii = document.getElementById('answer-10ii');
    const submitBtn10ii = document.querySelector('#question-10 .submit-btn:nth-of-type(2)');
    const editBtn10ii = document.querySelector('#question-10 .edit-btn:nth-of-type(2)');

    if (textarea10i) {
        textarea10i.disabled = false;
    }
    if (submitBtn10i) {
        submitBtn10i.style.display = 'inline-block';
    }
    if (editBtn10i) {
        editBtn10i.style.display = 'none';
    }

    if (textarea10ii) {
        textarea10ii.disabled = false;
    }
    if (submitBtn10ii) {
        submitBtn10ii.style.display = 'inline-block';
    }
    if (editBtn10ii) {
        editBtn10ii.style.display = 'none';
    }
}
...
function submitAnswer(questionNumber) {
    ...
    let textarea, submitBtn, editBtn;

    // Handle special case for question 10 parts
    if (questionNumber === '10i') {
        textarea = document.getElementById('answer-10i');
        submitBtn = document.querySelector('#question-10 .submit-btn:nth-of-type(1)');
        editBtn = document.querySelector('#question-10 .edit-btn:nth-of-type(1)');
    } else if (questionNumber === '10ii') {
        textarea = document.getElementById('answer-10ii');
        submitBtn = document.querySelector('#question-10 .submit-btn:nth-of-type(2)');
        editBtn = document.querySelector('#question-10 .edit-btn:nth-of-type(2)');
    } else {
        textarea = document.getElementById(`answer-${questionNumber}`);
        submitBtn = document.querySelector(`#question-${questionNumber} .submit-btn`);
        editBtn = document.querySelector(`#question-${questionNumber} .edit-btn`);
    }
