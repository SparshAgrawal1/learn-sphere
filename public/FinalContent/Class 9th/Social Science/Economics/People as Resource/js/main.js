...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            speak("Welcome to People as Resource. This chapter explores how population becomes human capital through education, training, and healthcare, contributing to economic growth rather than being a burden.");
            break;
            
        case 'overview':
            speak("People as Resource explains how population becomes human capital through education, training, and healthcare. It explores the positive aspects of a large population and shows through Sakal and Vilas's stories how investment in human capital can transform lives and contribute to economic growth.");
            break;
            
        case 'southafrica':
            speak("Economic Activities by Men and Women explores how people engage in various economic activities classified into primary, secondary, and tertiary sectors, and examines the division of labour between men and women in families and the workforce.");
            break;
            
        case 'whyconstitution':
            speak("Quality of Population explores how literacy rates, health indicators, and skill formation determine a country's growth rate, with detailed sections on education and health infrastructure in India.");
            break;
            
        case 'indianconstitution':
            speak("Unemployment is a critical issue in India, affecting both rural and urban areas differently. Rural areas face seasonal and disguised unemployment, while urban areas struggle with educated unemployment. Understanding unemployment helps us see how people can become valuable assets to the economy through education, training, and healthcare.");
            break;
            

        case 'summingup':
            speak("This section summarizes how education and health transform people into economic assets, covers economic activities across three sectors, examines unemployment issues, and concludes with a village story showing job creation through human capital development.");
            break;

        case 'activities':
            speak("Test your knowledge and understanding with these interactive activities about People as Resource.");
            break;
...
function startJourney() {
    ...
    showAchievement('Journey Begins', 'You started your learning journey with People as Resource!');
    speak("Welcome to the interactive lesson on People as Resource. Let's begin by understanding how population becomes human capital and contributes to national development through education, skills, and healthcare.");
}
...
// Quality of Population Card Narration Functions

// Card 1: Education
function toggleEducationNarration() {
    const btn = document.getElementById('educationSpeakerBtn');
    if (!btn) return;
...
// Card 2: Health
function toggleHealthNarration() {
    const btn = document.getElementById('healthSpeakerBtn');
    if (!btn) return;
...
// Quality of Population narration
function toggleQualityPopulationNarration() {
    const btn = document.getElementById('qualityPopulationSpeakerBtn');
    if (!btn) return;
...
// Economic Activities by Men and Women narration
function toggleEconomicActivitiesNarration() {
    const btn = document.getElementById('economicActivitiesSpeakerBtn');
    if (!btn) return;
...
// ====== People as Resource Card Narration Functions ======

// Card 1: Story of Sakal
function toggleSakalNarration() {
    const btn = document.getElementById('sakalSpeakerBtn');
    if (!btn) return;
...
// Card 2: Story of Vilas
function toggleVilasNarration() {
    const btn = document.getElementById('vilasSpeakerBtn');
    if (!btn) return;
...
// Card 3: Comparison
function toggleComparisonNarration() {
    const btn = document.getElementById('comparisonSpeakerBtn');
    if (!btn) return;
...
// Unemployment narration
function toggleUnemploymentNarration() {
    const btn = document.getElementById('unemploymentSpeakerBtn');
    if (!btn) return;
    ...
    const contentElement = document.getElementById('unemployment-content');
    ...
    function speakNext() {
        ...
        const text = paragraphs[currentIndex].textContent.trim();
        if (text) {
            const utterance = new SpeechSynthesisUtterance(text);
            utterance.rate = 0.9;
            utterance.pitch = 1.0;
    ...
    // Override stopAllNarration to set isStopped
    const originalStopAllNarration = stopAllNarration;
    stopAllNarration = function() {
        isStopped = true;
        originalStopAllNarration();
    };
