...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'From the Diary of Anne Frank'. This is a diary written by a young Jewish girl during World War II.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about diaries and personal records and how they help us express our thoughts and feelings.");
                }
            }
            break;
        ...
        case 'thinking-text':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Reading Comprehension section. Here you'll analyze the diary entries and poem and answer questions about them.");
            }
            break;
            
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore compound words and phrasal verbs from the text.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'From the Diary of Anne Frank'. Let's begin by exploring what you think about diaries and personal records. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'From the Diary of Anne Frank'. Let's begin by exploring what you think about diaries and personal records.");
        }
    }
}
