/**
 * Main JavaScript for A Triumph of Surgery interactive lesson
 */
        ...
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'A Triumph of Surgery'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'A Triumph of Surgery'. This is a story about a veterinary surgeon and his treatment of an overfed dog.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's explore what you know about pet care and veterinary practices.");
                }
            }
            break;
...
function updateProgress() {
    progress = (modulesCompleted.length / 5) * 100; // 5 modules (no poem module)
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'A Triumph of Surgery'. Let's begin by exploring what you know about pet care. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'A Triumph of Surgery'. Let's begin by exploring what you know about pet care.");
        }
    }
}
