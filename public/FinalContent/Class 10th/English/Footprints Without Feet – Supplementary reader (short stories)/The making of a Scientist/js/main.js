/**
 * Main JavaScript for The Making of a Scientist interactive lesson
 */
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
            if (window.narrator) {
                ...
                if (introModule) {
                    ...
                    let introContent = "Welcome to 'The Making of a Scientist'. ";
                    ...
                    window.narrator.speak("Welcome to the interactive English lesson on 'The Making of a Scientist'. This story shows how curiosity and determination can lead to scientific discoveries.");
                }
            }
            break;
        ...
        case 'prereading':
            if (window.narrator) {
                ...
                if (prereadingModule) {
                    ...
                    // Fallback if module not found
                    window.narrator.speak("Welcome to the Let's Begin section. Let's think about what makes a successful scientist and what qualities are needed for scientific discovery.");
                }
            }
            break;
        ...
        case 'thinking-language':
            if (window.narrator) {
                window.narrator.speak("Welcome to the Vocabulary and Grammar section. Here you'll explore words, expressions, and if-clauses from the story.");
            }
            break;
...
function startJourney() {
    ...
    if (narrator) {
        ...
        if (prereadingModule) {
            const contentBlocks = prereadingModule.querySelectorAll('.content-block');
            let prereadingContent = "Welcome to the interactive English lesson on 'The Making of a Scientist'. Let's begin by exploring what qualities you think are important for a scientist. ";
            ...
            // Fallback if module not found
            narrator.speak("Welcome to the interactive English lesson on 'The Making of a Scientist'. Let's begin by exploring what qualities you think are important for a scientist.");
        }
    }
}
