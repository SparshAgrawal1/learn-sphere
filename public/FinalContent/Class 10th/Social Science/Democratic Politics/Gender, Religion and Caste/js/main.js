...
const moduleOrder = ['intro', 'overview', 'southafrica', 'whyconstitution', 'indianconstitution', 'activities'];
...
function updateProgressNew(moduleId){
    ...
    // Progress based on completed modules: intro is 15%, remaining 5 modules share 85%
    const progressPercentage = 15 + Math.round((completedModules - 1) / 5 * 85);
    ...
    if (completedModules === 6) { // All 6 modules including intro
...
function startModuleNarration(moduleId) {
    ...
    switch(moduleId) {
        case 'intro':
              speak("Welcome to Gender, Religion and Caste. This chapter examines how differences based on gender, religion, and caste shape social and political life in India, exploring whether such expressions strengthen or challenge democracy.");
              break;

        case 'overview':
              speak("This chapter explores how social diversity based on gender, religion, and caste shapes India's democracy, examining whether political expressions of these differences are healthy for democratic systems.");
              break;
            
        case 'southafrica':
              speak("This section examines gender division as a form of social hierarchy, exploring how it manifests in public/private spheres, women's political representation, and the impact of feminist movements on gender equality.");
              break;
            
        case 'whyconstitution':
              speak("This section examines how religious differences are expressed in politics, exploring the relationship between religion and politics, the dangers of communalism, and the importance of secularism in maintaining democratic harmony.");
              break;
            
        case 'indianconstitution':
              speak("This section examines how caste divisions are expressed in politics, exploring caste inequalities, the role of caste in politics, how politics influences caste identities, and the current state of caste-based inequalities in India.");
              break;
            

        case 'activities':
            speak("Test your knowledge and understanding with these interactive activities about Gender, Religion and Caste.");
            break;
...
function startJourney() {
    ...
    showAchievement('Journey Begins', 'You started your learning journey with Gender, Religion and Caste!');
...
function updateProgress() {
    ...
    if (progressFill) {
        ...
        progressFill.textContent = `Question ${currentQuestionIndex + 1} of 4`;
    }
}
...
function checkQuizAnswers() {
    ...
    // Question 1: (b) Unequal roles assigned by the society to men and women
    const q1Answer = document.querySelector('input[name="q1"]:checked');
    if (q1Answer && q1Answer.value === 'b') {
        score++;
        results.push('<p class="correct-answer">✓ Question 1: Correct! Unequal roles assigned by the society to men and women.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 1: Incorrect. The correct answer is (b) Unequal roles assigned by the society to men and women.</p>');
    }

    // Question 2: (d) Panchayati Raj bodies
    const q2Answer = document.querySelector('input[name="q2"]:checked');
    if (q2Answer && q2Answer.value === 'd') {
        score++;
        results.push('<p class="correct-answer">✓ Question 2: Correct! Panchayati Raj bodies.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 2: Incorrect. The correct answer is (d) Panchayati Raj bodies.</p>');
    }

    // Question 3: (c) A and C
    const q3Answer = document.querySelector('input[name="q3"]:checked');
    if (q3Answer && q3Answer.value === 'c') {
        score++;
        results.push('<p class="correct-answer">✓ Question 3: Correct! A and C.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 3: Incorrect. The correct answer is (c) A and C.</p>');
    }

    // Question 4: (b) gives official status to one religion
    const q4Answer = document.querySelector('input[name="q4"]:checked');
    if (q4Answer && q4Answer.value === 'b') {
        score++;
        results.push('<p class="correct-answer">✓ Question 4: Correct! gives official status to one religion.</p>');
    } else {
        results.push('<p class="wrong-answer">✗ Question 4: Incorrect. The correct answer is (b) gives official status to one religion.</p>');
    }
...
// Gender and politics
function toggleGenderNarration() {
    const btn = document.getElementById('genderSpeakerBtn');
    if (!btn) return;
...
// Caste and Politics narration
function toggleCasteNarration() {
    const btn = document.getElementById('casteSpeakerBtn');
    if (!btn) return;
    ...
    // Use the exact text specified by user
    const curatedContent = "We have seen two instances of the expression of social divisions in the arena of politics, one largely positive and the other largely negative. Let us turn to our final case, that of caste and politics, that has both positive and the negative aspects.";
