...
function playListeningActivity() {
    if (narrator) {
        ...
        narrator.speak("A Visit to Bhitarkanika. Please listen carefully to the following passage.");
        
        // Set up callback to continue with the main transcript
        narrator.onEndCallback = function() {
            setTimeout(() => {
                ...
                // Set up callback for the rest of the passage
                narrator.onEndCallback = function() {
                    setTimeout(() => {
                        narrator.speak("The boat moved on, taking us deeper into the forest. Here we felt as though we had stepped into a time warp. In this awesome and mysterious place, birds of extraordinary plumage appeared before us. For the moment we revelled in the magnificence of nature which had us completely in its thrall. Among the birds, the kingfishers were the stars of the show. Crocodiles, large and small, slid into the water at our approach. Through the foliage we could see chital deer delicately browsing on fresh outcrops of leaves.");
                        
                        // Final callback
                        narrator.onEndCallback = function() {
                            setTimeout(() => {
                                narrator.speak("A herd of wild boar was spotted searching for succulent roots. High above us, open-billed storks stood sentry-like following our progress through their remarkable kingdom. The evening sun was beginning to paint the tree-lined horizon crimson and gold and a brooding silence enveloped us all. Now, please answer the questions about what you heard.");
                            }, 1000);
                        };
                    }, 1000);
                };
        ...
        // Fallback message without alert
